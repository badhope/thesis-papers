...
# =============================================
# Figure 2: Yearly Trends - FIXED version (no text overlap)
# =============================================
print("Regenerating Figure 2 with no text overlap...")
...
# Upper panel: AC signal (main focus)
...
# Add value labels ABOVE the points (no overlap)
...
# Lower panel: RC signal (smaller scale)
...
# Add value labels BELOW the points (no overlap)
...
plt.close()
print("Figure 2 regenerated successfully - no text overlap!")
...
for fname in ['Figure1_InvertedU_Theory.png', 'Figure2_Yearly_Trends.png', 'Figure3_Marginal_Effects.png']:
    fpath = os.path.join(out_dir, fname)
    if os.path.exists(fpath):
        size_kb = os.path.getsize(fpath) / 1024
        print(f"  {fname}: {size_kb:.1f} KB - OK")
    else:
